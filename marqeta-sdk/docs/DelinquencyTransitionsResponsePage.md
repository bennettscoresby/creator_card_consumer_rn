...
**data** | [**Array&lt;DelinquencyTransitionResponse&gt;**](DelinquencyTransitionResponse.md) | List of delinquency state transitions. | [default to undefined]
...
```typescript
import { DelinquencyTransitionsResponsePage } from './api';

const instance: DelinquencyTransitionsResponsePage = {
    count,
    data,
    end_index,
    is_more,
