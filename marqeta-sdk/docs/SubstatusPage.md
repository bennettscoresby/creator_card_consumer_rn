...
**data** | [**Array&lt;SubstatusResponse&gt;**](SubstatusResponse.md) | Contains one or more substatuses. | [default to undefined]
...
```typescript
import { SubstatusPage } from './api';

const instance: SubstatusPage = {
    count,
    data,
    end_index,
    is_more,
