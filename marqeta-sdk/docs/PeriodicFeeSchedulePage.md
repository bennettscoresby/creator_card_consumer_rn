...
**data** | [**Array&lt;PeriodicFeeSchedule&gt;**](PeriodicFeeSchedule.md) | List of account periodic fee schedules. | [default to undefined]
...
```typescript
import { PeriodicFeeSchedulePage } from './api';

const instance: PeriodicFeeSchedulePage = {
    count,
    data,
    end_index,
    is_more,
