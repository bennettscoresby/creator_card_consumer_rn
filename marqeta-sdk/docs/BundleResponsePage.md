...
**data** | [**Array&lt;BundleResponse&gt;**](BundleResponse.md) | Contains one or more bundles. | [default to undefined]
...
```typescript
import { BundleResponsePage } from './api';

const instance: BundleResponsePage = {
    count,
    data,
    end_index,
    is_more,
