...
**data** | [**Array&lt;DisputeResponse&gt;**](DisputeResponse.md) | Contains one or more disputes on a credit account. | [default to undefined]
...
```typescript
import { DisputeResponsePage } from './api';

const instance: DisputeResponsePage = {
    count,
    data,
    end_index,
    is_more,
