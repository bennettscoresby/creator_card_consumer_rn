...
**data** | [**Array&lt;AccountFeeResponse&gt;**](AccountFeeResponse.md) | Contains one or more account fees. | [default to undefined]
...
```typescript
import { AccountFeePage } from './api';

const instance: AccountFeePage = {
    count,
    data,
    end_index,
    is_more,
