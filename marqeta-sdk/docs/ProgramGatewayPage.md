...
**data** | [**Array&lt;ProgramGatewayResponse&gt;**](ProgramGatewayResponse.md) | Contains one or more Program Gateway objects. | [default to undefined]
...
```typescript
import { ProgramGatewayPage } from './api';

const instance: ProgramGatewayPage = {
    count,
    data,
    end_index,
    is_more,
