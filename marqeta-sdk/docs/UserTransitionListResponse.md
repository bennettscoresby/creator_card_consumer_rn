...
**data** | [**Array&lt;UserTransitionResponse&gt;**](UserTransitionResponse.md) | Array of user transition resources.  Resources are returned as appropriate to your query. | [optional] [default to undefined]
...
```typescript
import { UserTransitionListResponse } from './api';

const instance: UserTransitionListResponse = {
    count,
    data,
    end_index,
    is_more,
