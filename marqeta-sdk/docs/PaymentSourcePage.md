...
**data** | [**Array&lt;PaymentSourceResponse&gt;**](PaymentSourceResponse.md) | List of payment sources. | [default to undefined]
...
```typescript
import { PaymentSourcePage } from './api';

const instance: PaymentSourcePage = {
    count,
    data,
    end_index,
    is_more,
