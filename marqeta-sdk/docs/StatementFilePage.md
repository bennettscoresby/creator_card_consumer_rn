...
**data** | [**Array&lt;StatementFile&gt;**](StatementFile.md) | List of statement files. | [default to undefined]
...
```typescript
import { StatementFilePage } from './api';

const instance: StatementFilePage = {
    count,
    data,
    end_index,
    is_more,
