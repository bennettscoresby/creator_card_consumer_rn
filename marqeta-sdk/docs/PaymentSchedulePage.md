...
**data** | [**Array&lt;PaymentScheduleResponse&gt;**](PaymentScheduleResponse.md) | List of payment schedules. | [default to undefined]
...
```typescript
import { PaymentSchedulePage } from './api';

const instance: PaymentSchedulePage = {
    count,
    data,
    end_index,
    is_more,
