...
**data** | [**Array&lt;CardResponse&gt;**](CardResponse.md) | Contains one or more credit cards. | [default to undefined]
...
```typescript
import { AccountCardsPage } from './api';

const instance: AccountCardsPage = {
    count,
    data,
    end_index,
    is_more,
