...
**data** | [**Array&lt;PolicyDocumentResponse&gt;**](PolicyDocumentResponse.md) | One or more document policies. | [default to undefined]
...
```typescript
import { PoliciesDocumentPage } from './api';

const instance: PoliciesDocumentPage = {
    count,
    data,
    end_index,
    is_more,
