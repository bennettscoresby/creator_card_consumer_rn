...
**data** | [**Array&lt;AccountDocumentResponse&gt;**](AccountDocumentResponse.md) | Array of documents on the credit account. | [default to undefined]
...
```typescript
import { AccountDocumentsPage } from './api';

const instance: AccountDocumentsPage = {
    count,
    data,
    end_index,
    is_more,
