...
**data** | [**Array&lt;PolicyFeeResponse&gt;**](PolicyFeeResponse.md) | One or more fee policies. | [default to undefined]
...
```typescript
import { PolicyFeesPage } from './api';

const instance: PolicyFeesPage = {
    count,
    data,
    end_index,
    is_more,
