...
**data** | [**Array&lt;PolicyAprResponse&gt;**](PolicyAprResponse.md) | One or more APR policies. | [default to undefined]
...
```typescript
import { PolicyAprsPage } from './api';

const instance: PolicyAprsPage = {
    count,
    data,
    end_index,
    is_more,
